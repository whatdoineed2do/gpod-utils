% gpod-utils(SECTION) | User Commands
%
% "August 24 2025"
...
gpod-utils - program to do something

# SYNOPSIS

**gpod-utils** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**gpod-utils** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **gpod-utils** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**gpod-utils** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    gpod-utils. See **foo.conf**(5) for further details.
...
**gpod-utils** provides some return codes, that can be used in scripts:
...
Ilya Kargapolov <ikargapolov@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Ilya Kargapolov
